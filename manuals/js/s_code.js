...
s.linkDownloadFileTypes = "pkg,exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls"
...
function s_doPlugins(s) {
  ...
  //Sony Internal Marketing Code (SMCID)
  if( s.Util.getQueryParam("smcid") ){
    s.eVar40 = decodeURIComponent(s.Util.getQueryParam("smcid"));
    s.prop40 = "D=v40";
  }
